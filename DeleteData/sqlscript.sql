...
CREATE TABLE locations  
    ...
    , country_id     CHAR(2)  
    ,                CONSTRAINT locations_country_id_fk  
...
CREATE TABLE departments  
    ...
    ,                  CONSTRAINT departments_location_id_fk  
...
CREATE TABLE job_history  
    ...
    ,               CONSTRAINT job_history_employee_id_fk  
    ...
    ,               CONSTRAINT job_history_job_id_fk  
                       ...
                       REFERENCES jobs  
    , department_id NUMBER(4)  
    ,               CONSTRAINT job_history_department_id_fk  
                       FOREIGN KEY (department_id)  
                       REFERENCES departments 
...
ALTER TABLE employees   
  DISABLE CONSTRAINT employees_manager_id_fk;
